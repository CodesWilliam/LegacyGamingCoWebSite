...
<section class="legacyGamingMore">
    <h1 class="whatIsLegacy">What Is Legacy Gaming</h1>
    <div class="whatIsMore">
...
<section class="storeInfoMore">
    <div class="legacyHistoryMore">
        <h2 class="more">What Legacy Gaming Offers</h2>
...
<section class="gamingAtFinestMore">
    <div class="gamingAtFinestRead">
        ...
        <p>Legacy Gaming is unique in that it is built for every type of gamer, not just our Hardcore Gamers. Our
            ...
            As a diversity of brilliant minds come together ideas are born. These ideas will drive us into the future
            and help pioneer the next state of Arcade, VR, Computer, and even eSports Gaming. We will grow into
            Tournament and eSports Gaming as we enter Phase III. For this we require a loyal fan club to make Legacy
            their Home Base. Our future tournaments will allow competition in-store as well as from the luxury of your
            own home. Coming Soon!
        </p>
    </div>
</section>
